...
#pragma warning restore 0414
        ...
        {
            public OnUpdateListener() : base("com.onedevapp.nativeinappupdate.plugin.OnUpdateListener") { }
        ...
        public void CheckForUpdate(UpdateMode updateMode = UpdateMode.PLAY_STORE, UpdateType updateType = UpdateType.FLEXIBLE, string thirdPartyLink = "")
        {
            ...
            var manager = new AndroidJavaClass("com.onedevapp.nativeinappupdate.plugin.UpdateManager");
        ...
        public void PluginDebug(bool showLog = true)
        {
            ...
            var constantClass = new AndroidJavaClass("com.onedevapp.nativeinappupdate.plugin.Constants");
